...
- **立即刷新**（⌘R）、**配置 Key…**、**刷新频率**（5 / 10 / 15 分钟三档，勾选即生效并记忆）、**开机自启** 开关、退出

其他特性：

- ⏱ 自动刷新默认 15 分钟，可切换 5 / 10 / 15 分钟三档，选择自动记忆；合盖唤醒后立即补拉一次
...
**Q：顶栏显示 ⚠️？**
下拉查看具体原因：网络断开、Key 失效（401）或接口返回异常。多数情况恢复网络后下个刷新周期自愈（最长即所选刷新间隔），或点「立即重试」。
